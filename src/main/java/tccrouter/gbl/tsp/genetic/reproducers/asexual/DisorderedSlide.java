...
*/
    ...
    catch (Exception e)
    {
      System.err.println
      (
        "DisorderedSlide.reproduce() threw!"
      );
    }
...
/*
** Disorganize the selected subset of the codons.
*/
      ...
      for
      (
        int currentSlot = selectionCount - 1;
      ...
      )
      {
        ...
        int swapSlot   = mt.nextInt(currentSlot + 1); // include own slot
...
/*
** Copy the selected codons in disorder to the middle of the output
** genome.
*/
